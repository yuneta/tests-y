 ...
 *          Register
 ***************************************************************************/
PUBLIC void register_yuno_teston(void)
{
    GCLASS *gclass;
     ...
     */
    gclass = gobj_subclass_gclass(gclass_default_yuno(), GCLASS_YUNO_TESTON_NAME);
    ...
    gobj_register_yuno(ROLE_TESTONS, gclass, TRUE);
}
